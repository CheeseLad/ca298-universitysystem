...
const CreateNewCohort = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/cohort/`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
        body: JSON.stringify({ id, year: parseInt(year), degree: `${process.env.REACT_APP_API_URL}/api/degree/${degree}/`, name })
      });
